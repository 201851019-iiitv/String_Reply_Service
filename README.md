...
```
you can add new rule without modify existing code , you have to add in enum class about rule.
you can make a seperate class for adding new rule by implement the RuleService ,
you have to implement it's method about how new rule will be working.
make sure that enum value is same as className or bean of the implementing class.
As implementation of code is ServiceLocatorBean Factory will by default register new rule.
